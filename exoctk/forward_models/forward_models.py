...
def rescale_generic_grid(input_args, database_path):
    ...
    try:
        ...
        temp_range = np.arange(300, 2700, 100)
        ...
        model_space = [('condensation', ['local', 'rainout']),
                       ...
                       ('metallicity', ['-1.0', '+0.0', '+1.0', '+1.7', '+2.0', '+2.3']),
